                                ...
                                <tbody>
                                    @if(Session::has('cart'))
                                        @foreach ( $products as $product)
                                            <tr class="text-center">
                                                <td class="product-remove"><a href="{{ url('/suppdupanier/'.$product['product_id']) }}"><span class="ion-ios-close"></span></a></td>
                                                ...
                                                <td class="price">${{ $product['product_price'] }}</td>
                                                    <form action="{{ url('/modifier_quant/'.$product['product_id']) }}" method="POST">
                                                        {{ csrf_field() }}
                                                        <td class="quantity">
